      ...
      <div className="relative z-10 w-full h-full flex items-center justify-center px-4">
        <div className="w-full max-w-4xl">
          <motion.div 
            ...
            className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl p-4 md:p-8 relative overflow-hidden"
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.9 }}
              onClick={toggleMusic}
              className="absolute top-2 md:top-4 right-2 md:right-4 text-highlight opacity-50 hover:opacity-100 transition-opacity touch-manipulation"
            >
            ...
            <motion.div
              ...
              className="absolute top-4 left-4 text-highlight"
            >
